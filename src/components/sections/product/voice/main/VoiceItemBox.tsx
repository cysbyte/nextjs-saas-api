...
const VoiceItemBox: FC = () => {
  return (
    <div>
      <div className="border rounded-md bg-gray-100 shadow-xl basis-4/12 w-full md:w-[360px] h-auto justify-start px-6 py-6 flex flex-col hover:bg-gray-100 hover:scale-[1.02] active:scale-100 duration-300 hover:border-x-indigo-400">
