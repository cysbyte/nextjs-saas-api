    ...
    <section className="bg-hero-pattern bg-cover h-auto">
      <Wrapper>
        <div className="flex flex-col items-center justify-center">
          <div className="mt-12 md:mt-24  flex flex-col justify-center">
            <h1 className="mx-auto max-w-[50%] text-4xl sm:text-5xl font-bold mt-4 lg:leading-[60px]">
              AI Voice Generator
            </h1>
            <p className="mx-auto text-center mt-6 text-lg md:text-base text-slate-600 max-w-3xl leading-[30px]">
            ...
            <Image className="mt-10 mb-20 w-[90%] md:w-full" src={usecase} alt='Minimax Use Case'/>
        </div>
      </Wrapper>
    </section>
  );
