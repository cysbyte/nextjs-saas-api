    ...
    <div className="border rounded-md bg-white shadow-xl w-full h-auto justify-start px-6 py-6 flex flex-col">
          ...
          <div className="relative w-full h-auto mx-auto ml-4">
            ...
            {recordingStatus !== "inactive" && (
              <div
                ...
                style={{ width: `${Math.floor(milliseconds * 100 / 30000)}%` }}
              >
                <svg
                  width="680"
                  height="40"
      ...
      <div className="flex justify-between my-4">
        ...
        <div>
          <select
            id="microphone"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block p-2.5 w-fit"
          >
